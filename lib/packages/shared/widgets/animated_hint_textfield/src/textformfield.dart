...
class AnimatedTextFormField extends StatefulWidget {
  ...
  @override
  AnimatedTextFormFieldState createState() => AnimatedTextFormFieldState();
}

class AnimatedTextFormFieldState extends State<AnimatedTextFormField> {
  ...
  List<AnimatedText> _buildAnimatedTexts() => widget.hintTexts.map((text) {
    if (widget.animationType == Animationtype.typer) {
      return TyperAnimatedText(
        text,
        speed: Duration(
          milliseconds: widget.animationDuration.inMilliseconds ~/ text.length,
        ),
