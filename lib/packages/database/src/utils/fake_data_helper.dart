...
class FakeDataHelper {
  ...
  static String _seedId(String token) {
    final rest = const Uuid().v4().substring(
      8,
  ...
  static const List<Map<String, Object>> _diningTables = [
    {
      'label': 'Window View - T1',
      'no': 'T-01',
      'chairs': 2,
      'color': '4280391411',
    },
    {
      'label': 'Window View - T2',
      'no': 'T-02',
      'chairs': 2,
      'color': '4280391411',
    },
    {
      'label': 'Cozy Corner - T3',
      'no': 'T-03',
      'chairs': 4,
      'color': '4294198070',
    },
    {
      'label': 'Cozy Corner - T4',
      'no': 'T-04',
      'chairs': 4,
      'color': '4294198070',
    },
    {
      'label': 'Garden View - T5',
      'no': 'T-05',
      'chairs': 2,
      'color': '4282623326',
    },
    {
      'label': 'Garden View - T6',
      'no': 'T-06',
      'chairs': 2,
      'color': '4282623326',
    },
    ...
    {
      'label': 'Family Booth - T11',
      'no': 'T-11',
      'chairs': 8,
      'color': '4285952026',
    },
    {
      'label': 'Family Booth - T12',
      'no': 'T-12',
      'chairs': 8,
      'color': '4285952026',
    },
    ...
    {
      'label': 'Lounge Area - T15',
      'no': 'T-15',
      'chairs': 4,
      'color': '4294940672',
    },
    {
      'label': 'Lounge Area - T16',
      'no': 'T-16',
      'chairs': 4,
      'color': '4294940672',
    },
  ...
  static List<Map<String, dynamic>> get _menuItems => [
    ...
    {
      'cat': 'Combos & Specials',
      'sub': 'Signature Specials',
      'type': 'Veg',
      'simple': true,
      'name': 'Rice Bowl (Dal Makhani + Steam Rice)',
      'sell': 200.0,
      'cost': 105.0,
      'dur': 20,
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Burnt Garlic Rice + Aloo Tikki Wrap',
      'sell': 250.0,
      'cost': 130.0,
      'dur': 20,
      'desc':
          'Aromatic burnt garlic rice bundled with a spiced aloo tikki wrap.',
    },
    {
      'cat': 'Combos & Specials',
      'sub': 'Signature Specials',
      'type': 'Veg',
      'simple': true,
      'name': 'Margherita Pizza + Strawberry Shake + Tandoori Paneer Wrap',
      'sell': 250.0,
      'cost': 130.0,
      'dur': 25,
      'desc':
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Schezwan Fry Rice + Tandoori Paneer Pizza',
      'sell': 300.0,
      'cost': 156.0,
      'dur': 25,
      'desc':
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Italian Rice + Farmhouse Pizza',
      'sell': 300.0,
      'cost': 156.0,
      'dur': 25,
      'desc':
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Caramel Biscoff Frappe',
      'sell': 170.0,
      'cost': 74.0,
      'dur': 8,
      'desc':
          'Blended iced coffee with caramel syrup and biscoff cookie crumble.',
    },
    {
      'cat': 'Coffee',
      'sub': 'Cold Coffee & Frappes',
    ...
    },
    {
      ...
      'dur': 10,
      'desc':
          'Indulgent shake blended with Nutella and chunks of fudgy brownie.',
    },
    {
      'cat': 'Shakes & Hot Chocolate',
      'sub': 'Shakes',
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Chunky Biscoff Hot Chocolate',
      'sell': 120.0,
      'cost': 52.0,
      'dur': 8,
      'desc':
    ...
    {
      'cat': 'Burgers & Sandwiches',
      'sub': 'Sandwiches & Croissant',
      'type': 'Veg',
      'simple': true,
      'name': 'Bread Butter Chutney',
      'sell': 40.0,
      'cost': 15.0,
      'dur': 5,
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Cheese Overload Loaded Fries',
      'sell': 170.0,
      'cost': 73.0,
      'dur': 12,
    ...
    // --- Pizza & Pasta ---
    {
      ...
      'dur': 20,
      'desc':
          'Classic Margherita with tomato base, mozzarella and fresh basil.',
    },
    {
      'cat': 'Pizza & Pasta',
      'sub': 'Pizza',
    ...
    },
    {
      ...
      'type': 'Veg',
      'simple': true,
      'name': 'Coozy Special Cheese Masala Oats',
      'sell': 100.0,
      'cost': 43.0,
      'dur': 12,
      'desc':
  ...
  static Future<int> _generateMenuItems(
    ...
    final subMap = {
      for (final s in subcategories) '${s.categoryId}__${s.name}': s.id,
    };
  ...
  static Future<int> _generateRecipes(CoozyDatabase db, Random random) async {
    ...
    final recipes = [
      ...
      },
      {
        ...
        'translated_ingredients':
            'Black Lentils, Rajma, Butter, Cream, Tomatoes',
        'cuisine': 'Punjabi',
        'diet': 'Vegetarian',
        'course': 'Main Course',
        'prepMins': 15,
      ...
      },
      {
        ...
        'ingredients':
            'Bread, cheddar, mozzarella, gouda, cream cheese, butter',
        'translated_ingredients':
            'Bread, Cheddar, Mozzarella, Gouda, Cream Cheese',
        'cuisine': 'Continental',
        'diet': 'Vegetarian',
        'course': 'Snack',
        'prepMins': 5,
      ...
      await db
          ...
          .insert(
            RecipesTableCompanion.insert(
              ...
              recipeTranslatedIngredientList: Value(
                r['translated_ingredients'] as String,
              ),
          ...
          .insert(
            InventoryTableCompanion.insert(
              ...
              shortDescription: Value(
                '${inv['name']} – standard café stock item.',
              ),
  ...
  static Future<int> _generateReservations(
    ...
    for (int r = 0; r < 15; r++) {
      ...
      final baseNotes =
          reservationNotes[random.nextInt(reservationNotes.length)];
  ...
  static Future<int> _generateOrders(
    ...
    for (int tIndex = 0; tIndex < activeTablesCount; tIndex++) {
      ...
      double activeSubtotal = 0.0;
      for (final item in chosenItems) {
        final sPrice = item.sellingPrice ?? 120.0;
        activeSubtotal += sPrice;
      }
      activeSubtotal = double.parse(activeSubtotal.toStringAsFixed(2));
      final activeTax = double.parse(
        (activeSubtotal * 0.05).toStringAsFixed(2),
      );
      final activeGrandTotal = double.parse(
        (activeSubtotal + activeTax).toStringAsFixed(2),
      );
    ...
    for (int o = 0; o < 147; o++) {
      ...
      if (chosenPayment == 'Cash') {
        cashRec = (grandTotal / 10).ceil() * 10.0;
        changeAmt = double.parse((cashRec - grandTotal).toStringAsFixed(2));
      }
      ...
      final orderId = await db
          ...
          .insert(
            OrdersTableCompanion.insert(
              ...
              changeAmount: Value(changeAmt),
              placedAt: Value(oIso),
              preparationStartedAt: Value(
                oDate.add(const Duration(minutes: 5)).toIso8601String(),
              ),
              readyAt: Value(
                oDate.add(const Duration(minutes: 18)).toIso8601String(),
              ),
              servedAt: Value(servedIso),
            ),
          );
      inserted++;

      for (final rec in itemRecords) {
        await db
            .into(db.orderItemsTable)
            .insert(
              OrderItemsTableCompanion.insert(
                ...
                menuItemId: Value(rec.itemId),
                quantity: Value(rec.qty),
                sellingPrice: Value(rec.sPrice),
                costPrice: Value(rec.cPrice),
  ...
  static Future<int> _generateInvoices(
    ...
    // Ensure payment modes are present and build name-to-id map
    var existingPaymentModes = await db.select(db.paymentModesTable).get();
    if (existingPaymentModes.isEmpty) {
      await db.batch((batch) {
        for (final m in paymentMethods) {
          batch.insert(
            db.paymentModesTable,
            PaymentModesTableCompanion.insert(paymentMethodName: m),
          );
        }
      });
      existingPaymentModes = await db.select(db.paymentModesTable).get();
    }
    final paymentModeMap = {
      for (final pm in existingPaymentModes)
        pm.paymentMethodName.toLowerCase(): pm.id,
    };

    // Cache menu items for name lookup
    final allMenuItems = await db.select(db.menuItemsTable).get();
    final menuItemMap = {for (final m in allMenuItems) m.id: m};
        ...
        for (final item in orderItems) {
          ...
          invoiceItemCompanions.add(
            InvoiceItemsTableCompanion.insert(
              ...
              taxAmount: Value(
                double.parse((itemTotal * 0.05).toStringAsFixed(2)),
              ),
              createdDate: Value(orderDateStr),
            ),
          );
        }
      } else {
  ...
  static Future<Map<String, int>> getDatasetCounts(CoozyDatabase db) async {
    ...
    counts['recipes'] = await queryCount(
      "SELECT COUNT(*) as c FROM recipes WHERE recipe_original_name IN (${['Espresso Cappuccino Blend', 'Caramel Biscoff Frappe', 'Tandoori Paneer Pizza', 'Nutella Brownie Shake', 'Spicy Ramen with Cheese', 'Cheese Overload Loaded Fries', 'Dal Makhani', 'Coozy 4 Cheese Grill Sandwich'].map((n) => "'${n.replaceAll("'", "''")}'").join(',')})",
    );
