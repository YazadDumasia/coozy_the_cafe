...
class _CashPaymentViewState extends State<CashPaymentView> {
  ...
  final List<int> _quickAddValues = [10, 20, 50, 100, 200, 500, 2000];
  ...
  void _addQuickAmount(int amount) {
    ...
    final updatedText = updated % 1 == 0 ? updated.toInt().toString() : updated.toStringAsFixed(2);
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          Text(
                            context.tr(
                                  shared.LocaleKeys.checkoutCashReceivedOptional,
                                  track: shared.TrackConstants.checkoutPageTrack,
                                ) ??
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: theme.colorScheme.primaryContainer.withValues(alpha: isDark ? 0.3 : 0.4),
