...
class RecipeInstructionsSection extends StatefulWidget {
  ...
  @override
  State<RecipeInstructionsSection> createState() =>
      _RecipeInstructionsSectionState();
}
...
class _RecipeInstructionsSectionState extends State<RecipeInstructionsSection> {
                      ...
                      Expanded(
                        child: Text(
                          context.tr(
                                shared
                                    .LocaleKeys
                                    .recipesDetailInstructionsLabel,
  ...
  Widget instructionsInfoWidget() {
    ...
    for (
      int i = 0;
      i < widget.stateHolder.isInstructionEnglishTranslationSelection.length;
      i++
    ) {
      if (widget.stateHolder.isInstructionEnglishTranslationSelection[i] &&
          i == 2) {
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            ...
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              Expanded(child: Text(widget.stateHolder.instructionInfoString)),
            ],
          ),
              ...
              children: <Widget>[
                Expanded(
                  child: TextButton.icon(
                    onPressed: () async {
                      _showInstructionLanguageSelectionBottomSheet(context);
                    },
                    ...
                    label: Row(
                      ...
                      children: <Widget>[
                        ...
                        const SizedBox(width: 5),
                        Text(
                          widget.stateHolder.instructionSelectedLanguage.name,
                          textAlign: TextAlign.center,
                        ),
                      ],
                    ),
  ...
  void _showInstructionLanguageSelectionBottomSheet(BuildContext context) {
    ...
    showModalBottomSheet(
      ...
      if (selectedLanguage != null) {
        widget.stateHolder.updateInstructionLanguage(selectedLanguage);
        _translateInstructions(
          'en',
          widget.stateHolder.instructionSelectedLanguage.code2,
        );
      }
    });
  }

  Future<void> _translateInstructions(
    String? fromLanguage,
    String? toLanguage,
  ) async {
    try {
      ...
      await widget.translator
          .translate(
            widget.stateHolder.recipe.recipeTranslatedInstructions ?? '',
