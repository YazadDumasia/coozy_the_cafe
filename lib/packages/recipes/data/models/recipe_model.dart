...
class RecipeModel extends Recipe {
  ...
  factory RecipeModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['recipe_translated_ingredient_list'] != null) {
      if (json['recipe_translated_ingredient_list'] is List) {
        ingredientListStr = (json['recipe_translated_ingredient_list'] as List)
            .join(',');
      } else {
        ingredientListStr = json['recipe_translated_ingredient_list']
            .toString();
      }
    }
    ...
    return RecipeModel(
      ...
      recipeOriginalIngredients:
          json['recipe_original_ingredients'] ?? json['recipe_ingredients'],
      ...
      recipeOriginalInstructions:
          json['recipe_original_instructions'] ?? json['recipe_instructions'],
  ...
  db.RecipesTableCompanion toCompanion() {
    return db.RecipesTableCompanion(
      ...
      recipeOriginalName: recipeOriginalName == null
          ? const Value.absent()
          : Value(recipeOriginalName),
      translatedRecipeName: translatedRecipeName == null
          ? const Value.absent()
          : Value(translatedRecipeName),
      recipeOriginalIngredients: recipeOriginalIngredients == null
          ? const Value.absent()
          : Value(recipeOriginalIngredients),
      recipeTranslatedIngredientList: recipeTranslatedIngredientList == null
          ? const Value.absent()
          : Value(recipeTranslatedIngredientList),
      recipeTranslatedIngredients: recipeTranslatedIngredients == null
          ? const Value.absent()
          : Value(recipeTranslatedIngredients),
      recipePreparationTimeInMins: recipePreparationTimeInMins == null
          ? const Value.absent()
          : Value(recipePreparationTimeInMins),
      recipeCookingTimeInMins: recipeCookingTimeInMins == null
          ? const Value.absent()
          : Value(recipeCookingTimeInMins),
      recipeTotalTimeInMins: recipeTotalTimeInMins == null
          ? const Value.absent()
          : Value(recipeTotalTimeInMins),
      ...
      recipeCuisine: recipeCuisine == null
          ? const Value.absent()
          : Value(recipeCuisine),
      recipeCourse: recipeCourse == null
          ? const Value.absent()
          : Value(recipeCourse),
      recipeDiet: recipeDiet == null ? const Value.absent() : Value(recipeDiet),
      recipeOriginalInstructions: recipeOriginalInstructions == null
          ? const Value.absent()
          : Value(recipeOriginalInstructions),
      recipeTranslatedInstructions: recipeTranslatedInstructions == null
          ? const Value.absent()
          : Value(recipeTranslatedInstructions),
      recipeReferenceUrl: recipeReferenceUrl == null
          ? const Value.absent()
          : Value(recipeReferenceUrl),
